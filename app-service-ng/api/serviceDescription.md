...
This service implements Ably pub/sub interface allowing unidentified clients to subscribe for `live:main` channel and receive periodic updates on live games score and status. 
