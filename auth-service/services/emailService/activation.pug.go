...
const (
	activation__0 = `<!DOCTYPE html><html lang="en" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office"><head><meta charset="utf-8"/><meta http-equiv="x-ua-compatible" content="ie=edge"/><meta name="viewport" content="width=device-width, initial-scale=1"/><meta name="x-apple-disable-message-reformatting"/><!-- 
      ...
      <![endif] --><style type="text/css">      @import url('https://fonts.googleapis.com/css?family=Merriweather|Open+Sans');
...
</style></head><body style="margin:0;padding:0;width:100%;word-break:break-word;-webkit-font-smoothing:antialiased;"><div lang="en" style="display:none;"></div><table lang="en" bgcolor="#EEEEEE" cellpadding="16" cellspacing="0" role="presentation" width="100%"><tr><td align="center"><table class="container" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0" role="presentation" width="600"><tr><td align="left">`
	activation__1 = `</td></tr></table></td></tr></table></body></html>`
	activation__2 = `<table cellpadding="0" cellspacing="0" role="presentation" width="100%"><tr><td style="padding: 0 24px;"><table cellpadding="0" cellspacing="0" role="presentation" width="100%"><tr>`
	activation__3 = `</tr></table></td></tr></table>`
	activation__4 = `<td class="col" width="138">`
	activation__5 = `</td>`
	activation__6 = `<div class="one">One</div>`
	activation__7 = `<td class="col" width="414">`
	activation__9 = `<div class="two">Two</div>`
)

func ActivationRender(wr io.Writer) {
