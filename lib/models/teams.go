...
var (
	teamAllColumns            = []string{"id", "name", "arena", "color", "rsc_id", "created_at", "updated_at", "display_name"}
	teamColumnsWithoutDefault = []string{"name", "arena", "color", "rsc_id"}
	teamColumnsWithDefault    = []string{"id", "created_at", "updated_at", "display_name"}
